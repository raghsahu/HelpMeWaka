...
public class Validation {
    ...
    public boolean isMaxCharPassword(String input) {
        if (input.equals("") || input.isEmpty() || input.length()< 7||input.length()>12) {
            return false;
        }
        return true;
    }
    ...
    public boolean isConfirmPassword(String input, String confirm) {
        if (input.equals("") || input.equals(confirm) || input.isEmpty() || input.length() < 7 || input.length() > 12) {
            return false;
        }
        return true;
    }
